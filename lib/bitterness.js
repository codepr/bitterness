  ...
  return {
    ...
    average: function(hop_grams,  time, alpha_acids, batch_size, original_gravity, final_volume, height) {
      if(final_volume != undefined) {
        height = height || 0;
        return Math.round(((this.rager(hop_grams,  time, alpha_acids, batch_size, original_gravity) + this.tinseth(hop_grams,  time, alpha_acids, batch_size, original_gravity) + this.garetz(hop_grams,  time, alpha_acids, batch_size, original_gravity, final_volume, height)) / 3));
      }
      else return ((this.rager(hop_grams,  time, alpha_acids, batch_size, original_gravity) + this.tinseth(hop_grams,  time, alpha_acids, batch_size, original_gravity)) / 2);
    }
  };
})();
