  ...
  return {
    ...
    rager: function(hop_grams, time, alpha_acids, batch_size, original_gravity) {
      ...
      if(arguments.length < 5) {
        ...
        current.ht = 0;
        result = (hop_grams * util(time) * alpha_acids * factor) /
    ...
    garetz: function(hop_grams, time, alpha_acids, batch_size, original_gravity, final_volume, height) {
      ...
      if(arguments.length < 5) {
        ...
        if(s_metric == false) factor = 7.490;
        fr = (util(time) * alpha_acids * hop_grams * factor) / (650 * batch_size * gf * tf);
    ...
    average: function(hop_grams, time, alpha_acids, batch_size, original_gravity, final_volume, height) {
      ...
      if(arguments.length < 5) {
        ...
        result = ((this.rager(hop_grams, time, alpha_acids, batch_size, original_gravity) +
                   this.tinseth(hop_grams, time, alpha_acids, batch_size, original_gravity) +
                   this.garetz(hop_grams, time, alpha_acids, batch_size, original_gravity, final_volume, current.ht)) / 3);
        ibus.pop();
        ibus.pop();
        ibus.pop();
        ibus.push(result);
